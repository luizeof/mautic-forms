...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $view['assets']->getUrl('themes/purple/css/default-style.css'); ?>" type="text/css" />
        <link rel="stylesheet" href="<?php echo $view['assets']->getUrl('themes/purple/css/form-style.css'); ?>" type="text/css" />
